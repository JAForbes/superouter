...
route.toURL(
    route.Group({ organization_id: '1', group_id: '2' })
)
//=> /1/groups/2

route.parseURL('/1/groups/2')
...
m.route(
    document.body
    ,'/'
    , Object.fromEntries(Object.entries(Example.patterns).flatMap( ([k,v]) => v.map( v2 => [v2, Components[k]]) )) 
)
